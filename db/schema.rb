...
ActiveRecord::Schema[7.0].define(version: 2022_12_17_112334) do
  ...
  create_table "glucometer_readings", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.integer "patient_id"
    t.integer "reading"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
